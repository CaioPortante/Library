        ...
        <div class="relative w-full max-w-2xl px-6">
            ...
            <div class="flex flex-row gap-4">
                <a href="{{ route("admin.books") }}">
                    <button type="submit" class="text-white bg-gray-600 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center">
                        Voltar
                    </button>
                </a>
