    ...
    <form method="post" action="{{ route('admin.books.add.save') }}" class="flex justify-center">
        ...
        <div class="relative w-full max-w-2xl px-6">
            ...
            <div class="mb-5">
                ...
                <textarea id="description" name="description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"></textarea>
            </div>
            <div class="mb-5">
            ...
            <div class="flex flex-row gap-4">
                <a href="{{ route("admin.books") }}">
                    <button type="button" class="text-white bg-gray-600 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full px-5 py-2.5 text-center">Voltar</button>
                </a>
